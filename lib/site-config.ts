...
export const company = {
  ...
  phone: '+375 29 342 42 36',
  phoneHref: 'tel:+375293424236',
...
export const benefits = [
  ...
  },
  {
    ...
    description: 'Сотни довольных клиентов по всей Гомельской области.',
  },
  {
    value: 'от 1 года',
    label: 'гарантия',
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    car: 'Volkswagen Polo',
    rating: 5,
    text: 'Записалась утром, к обеду забрала машину. Всё "по-красоте". Приятный сервис и честная цена. Рекомендую всем знакомым.',
  },
  {
    name: 'Сергей П.',
    car: 'Toyota Camry',
  ...
  },
  {
    ...
    car: 'Kia Sportage',
    rating: 5,
    text: 'Очень довольна результатом! Машина смотрится дорого и солидно. Отдельное спасибо за консультацию по выбору затемнения.',
  },
  {
    name: 'Виталий Р.',
    car: 'Audi A6',
  ...
  },
  {
    ...
    car: 'Hyundai Tucson',
    rating: 5,
    text: 'Лучшая тонировака в Гомеле! Чистый бокс, вежливые мастера, результат превзошёл ожидания. Тонировка держится отлично, никаких нареканий.',
  },
]
